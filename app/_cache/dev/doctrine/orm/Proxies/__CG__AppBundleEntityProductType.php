...
class ProductType extends \AppBundle\Entity\ProductType implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductType' . "\0" . 'id', 'products', 'creator', '' . "\0" . 'AppBundle\\Entity\\ProductType' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\ProductType' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\ProductType' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\ProductType' . "\0" . 'deleted');
        }
