 ...
 */
class PageCategory extends \AppBundle\Entity\PageCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PageCategory' . "\0" . 'id', 'pages', 'products', 'creator', '' . "\0" . 'AppBundle\\Entity\\PageCategory' . "\0" . 'deleted', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PageCategory $proxy) {
