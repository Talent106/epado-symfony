...
class PageType extends \AppBundle\Entity\PageType implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PageType' . "\0" . 'id', 'pages', 'products', 'creator', '' . "\0" . 'AppBundle\\Entity\\PageType' . "\0" . 'deleted', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale');
        }
