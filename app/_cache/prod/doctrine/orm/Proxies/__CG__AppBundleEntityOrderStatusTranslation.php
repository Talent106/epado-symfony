 ...
 */
class OrderStatusTranslation extends \AppBundle\Entity\OrderStatusTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\OrderStatusTranslation' . "\0" . 'name', 'subject', 'mail', 'sms', 'id', 'locale', 'translatable');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderStatusTranslation $proxy) {
