 ...
 */
class Cemetery extends \AppBundle\Entity\Cemetery implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Cemetery' . "\0" . 'id', 'image', 'images', 'pages', '' . "\0" . 'AppBundle\\Entity\\Cemetery' . "\0" . 'name', 'address', 'localisation', 'description', 'creator', '' . "\0" . 'AppBundle\\Entity\\Cemetery' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Cemetery' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Cemetery' . "\0" . 'deleted', 'checked');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cemetery $proxy) {
