 ...
 */
class TextTranslation extends \AppBundle\Entity\TextTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\TextTranslation' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\TextTranslation' . "\0" . 'menu_title', '' . "\0" . 'AppBundle\\Entity\\TextTranslation' . "\0" . 'content', 'id', 'locale', 'translatable');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TextTranslation $proxy) {
    ...
    public function setTranslatable($translatable)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTranslatable', array($translatable));
    ...
    public function getTranslatable()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTranslatable', array());
