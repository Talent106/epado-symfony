...
class Mail extends \AppBundle\Entity\Mail implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Mail' . "\0" . 'id', 'creator', 'send_mail', 'send_sms', '' . "\0" . 'AppBundle\\Entity\\Mail' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Mail' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Mail' . "\0" . 'deleted', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale');
        }
