 ...
 */
class ProductTranslation extends \AppBundle\Entity\ProductTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductTranslation' . "\0" . 'name', 'description', 'document', 'id', 'locale', 'translatable');
        }
