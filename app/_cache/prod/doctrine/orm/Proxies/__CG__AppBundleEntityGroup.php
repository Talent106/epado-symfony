...
class Group extends \AppBundle\Entity\Group implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'id', 'pages', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'name', 'description', 'creator', '' . "\0" . 'AppBundle\\Entity\\Group' . "\0" . 'deleted');
        }
