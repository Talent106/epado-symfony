 ...
 */
class Audiobook extends \AppBundle\Entity\Audiobook implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Audiobook' . "\0" . 'id', 'page', 'sort', 'file', '' . "\0" . 'AppBundle\\Entity\\Audiobook' . "\0" . 'name', 'description', '' . "\0" . 'AppBundle\\Entity\\Audiobook' . "\0" . 'path', '' . "\0" . 'AppBundle\\Entity\\Audiobook' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Audiobook' . "\0" . 'updated');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Audiobook $proxy) {
