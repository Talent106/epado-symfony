 ...
 */
class OrderStatusHistory extends \AppBundle\Entity\OrderStatusHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\OrderStatusHistory' . "\0" . 'id', 'order', 'status', 'creator', '' . "\0" . 'AppBundle\\Entity\\OrderStatusHistory' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\OrderStatusHistory' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\OrderStatusHistory' . "\0" . 'deleted');
        }
