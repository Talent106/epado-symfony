 ...
 */
class PageTranslation extends \AppBundle\Entity\PageTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\PageTranslation' . "\0" . 'name', 'description', 'long_description', '' . "\0" . 'AppBundle\\Entity\\PageTranslation' . "\0" . 'first_name', '' . "\0" . 'AppBundle\\Entity\\PageTranslation' . "\0" . 'last_name', 'id', 'locale', 'translatable');
        }
