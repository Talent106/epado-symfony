 ...
 */
class MailTranslation extends \AppBundle\Entity\MailTranslation implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MailTranslation' . "\0" . 'name', 'subject', 'mail', 'sms', 'id', 'locale', 'translatable');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MailTranslation $proxy) {
