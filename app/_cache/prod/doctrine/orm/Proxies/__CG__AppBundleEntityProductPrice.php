 ...
 */
class ProductPrice extends \AppBundle\Entity\ProductPrice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductPrice' . "\0" . 'id', 'product', '' . "\0" . 'AppBundle\\Entity\\ProductPrice' . "\0" . 'currency', 'price', '' . "\0" . 'AppBundle\\Entity\\ProductPrice' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\ProductPrice' . "\0" . 'updated');
        }
    ...
    public function getPriceDiscount($discount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPriceDiscount', array($discount));

        return parent::getPriceDiscount($discount);
    }
    ...
    public function getPriceDiscountAmount($discount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPriceDiscountAmount', array($discount));

        return parent::getPriceDiscountAmount($discount);
    }
