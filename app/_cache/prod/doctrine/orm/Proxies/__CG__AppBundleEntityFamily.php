...
class Family extends \AppBundle\Entity\Family implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Family' . "\0" . 'id', 'image', 'images', 'credentials', 'pages', '' . "\0" . 'AppBundle\\Entity\\Family' . "\0" . 'name', 'description', 'creator', '' . "\0" . 'AppBundle\\Entity\\Family' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Family' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Family' . "\0" . 'deleted');
        }
