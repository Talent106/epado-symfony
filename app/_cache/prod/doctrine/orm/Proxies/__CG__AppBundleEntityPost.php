...
class Post extends \AppBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'id', 'posts', 'parent', 'page', 'creator', 'message', 'count', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'updated', '' . "\0" . 'AppBundle\\Entity\\Post' . "\0" . 'deleted');
        }
