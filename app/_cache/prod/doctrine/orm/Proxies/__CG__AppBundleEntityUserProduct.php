 ...
 */
class UserProduct extends \AppBundle\Entity\UserProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\UserProduct' . "\0" . 'id', 'product', 'creator', 'user', '' . "\0" . 'AppBundle\\Entity\\UserProduct' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\UserProduct' . "\0" . 'updated');
        }
