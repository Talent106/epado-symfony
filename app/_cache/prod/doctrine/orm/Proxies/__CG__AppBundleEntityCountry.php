...
class Country extends \AppBundle\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Country' . "\0" . 'id', 'products', 'addresses', '' . "\0" . 'AppBundle\\Entity\\Country' . "\0" . 'code', 'page', 'billing', 'delivery', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale');
        }
