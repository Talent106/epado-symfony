 ...
 */
class Text extends \AppBundle\Entity\Text implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Text' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Text' . "\0" . 'name', 'header', 'footer', 'sort', 'translations', 'newTranslations', 'currentLocale', 'defaultLocale');
        }
