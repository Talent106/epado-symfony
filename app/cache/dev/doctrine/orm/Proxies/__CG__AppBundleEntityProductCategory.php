...
class ProductCategory extends \AppBundle\Entity\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'id', 'products', 'creator', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'created', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'updated', 'commission', '' . "\0" . 'AppBundle\\Entity\\ProductCategory' . "\0" . 'deleted'];
        }
